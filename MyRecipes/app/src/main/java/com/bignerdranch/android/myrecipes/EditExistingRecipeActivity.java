...
public class EditExistingRecipeActivity extends AppCompatActivity {
    private TextView inputRecipeName;
    String recipeName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button addIngredientButton = findViewById(R.id.add_ingredient_button_edit);
    ...
    private void configureBackToMainButton() {
        Button mainMenuButton = findViewById(R.id.back_to_main_edit);
        mainMenuButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                if(ingredientModels.size() > 0 || inputRecipeName.length() > 0){
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditExistingRecipeActivity.this);
    ...
    private void configureSaveButton(){
        Button createSaveRecipeButton = findViewById(R.id.save_recipe_edit);
